...
public class DoctorVerHistorialMedicoPacienteIDViewController {
    ...
    private void confirmar(ActionEvent event) throws IOException {
        ...
        if (paciente == null) {
            ...
            Navegacion.cambiarVista("/co/edu/uniquindio/poo/proyectojavafx/Doctor-VerHistorialMedicoPaciente.fxml");
        }
    }
